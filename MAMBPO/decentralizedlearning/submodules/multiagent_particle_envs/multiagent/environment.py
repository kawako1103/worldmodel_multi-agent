...
# from gym.envs.registration import EnvSpec # これ使われてないやん
...
# gymのEnvを継承して、マルチエージェント環境に特化した追加のロジックを持つ
    ...
    def render(self, mode='human'):
        ...
        for i in range(len(self.viewers)):
            ...
            if self.viewers[i] is None:
                ...
                # from multiagent import my_rendering
        ...
        if self.render_geoms is None:
            ...
            for entity in self.world.entities:
                ...
                # geom = my_rendering.make_circle(entity.size)
                # xform = my_rendering.Transform()
        ...
        results = []
        for i in range(len(self.viewers)):
            from multiagent import rendering # ここを変更した。
            # from multiagent import my_rendering
